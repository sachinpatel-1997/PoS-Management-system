...
class InvoiceController extends Controller
{
    public function view()
    {
        ...
        return view('admin.invoice.view-invoice', compact('allData'));
    ...
    function pendingList(){
        ...
        return view('admin.invoice.pending-invoice-list', compact('allData'));
    }
    ...
    public function approve($id)
    {
        ...
        return view('admin.invoice.invoice-approve', compact('invoice'));
    }
    ...
    {
        $allData = Invoice::orderBy('date', 'desc')->orderBy('id', 'desc')->where('status', '1')->get();
        return view('admin.invoice.print-invoice-list', compact('allData'));
    }
    ...
    public function dailyReport(){
        return view('admin.invoice.daily-invoice-report');
    }
